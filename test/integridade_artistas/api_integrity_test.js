  ...
  try {
    ...
    const testCases = [
      ...
      },
      {
        ...
        expectedStatus: 200,
        assertion: (status, body) => {
          return status === 200 && body.total_seguidores === 1 && Array.isArray(body.data) && body.data.length === 1;
        }
      },
      {
        ...
        expectedStatus: 200,
        assertion: (status, body) => {
          return status === 200 && body.message && body.message.toLowerCase().includes("removido com sucesso");
        }
      },
      {
