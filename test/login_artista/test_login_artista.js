...
async function main() {
  ...
  try {
    ...
    console.log(
      `[+] Screenshot 2 (Dashboard Utilizador Comum) guardado em: ${loginUserScreenshotPath}`,
    )
    ...
    const promoteButton = await driver.findElement(
      By.xpath("//button[contains(., 'Tornar-me Artista')]"),
    )
